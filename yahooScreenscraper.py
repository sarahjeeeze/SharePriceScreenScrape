...
def parse(ticker):
	...
	try:
		...
		summary_data.update({'currentPrice':currentPrice,'1y Target Est':y_Target_Est,'EPS (TTM)':eps,'Earnings Date':earnings_date,'ticker':ticker,'url':url,'currentRatio':currentRatio})
		return summary_data
	except:
